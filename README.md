...
| User AI session hours | 8.2h | 25.4h | 71.3h | 71.3h |
| AI worker hours | 0.0h | 0.0h | 15.5h | 15.5h |
| AI concurrency hours | 9.3h | 29.3h | 101.5h | 101.5h |
| Interactive sessions | 4 | 64 | 93 | 93 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 4,000 | 6K | 1.3M | 504.5M | $1,579.11 | $6,811.46 | $0.00 |
...
| **Total** | **14,707** | **622K** | **4.8M** | **1,113.2M** | **$1,892.49** | **$8,568.91** | **$932.79** |

_1,172.8M total tokens processed. 94.9% cache hit rate._

_$9,501.70 total saved ($8,568.91 caching + $932.79 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 3,999 | 6K | 1.3M | 503.7M | $857.84 | $6,800.97 | $0.00 |
| claude-sonnet-4-6 | 5,950 | 6K | 1.9M | 343.8M | $132.07 | $928.36 | $528.33 |
| anthropic/claude-sonnet-4.6 | 21 | 137K | 11K | 1.0M | $0.87 | $2.77 | $3.56 |
| **Total** | **9,970** | **150K** | **3.3M** | **848.6M** | **$990.78** | **$7,732.10** | **$531.90** |

_1,012.3M total tokens processed. 88.7% cache hit rate._

_$8,264.00 total saved ($7,732.10 caching + $531.90 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-15 21:44 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
