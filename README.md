...
| User AI session hours | 9.8h | 38.3h | 42.4h | 42.4h |
| AI worker hours | 0.0h | 0.0h | 15.5h | 15.5h |
| AI concurrency hours | 13.2h | 46.1h | 68.3h | 68.3h |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 5,000 | 7K | 1.9M | 623.1M | $1,931.64 | $8,412.77 | $0.00 |
...
| **Total** | **15,707** | **623K** | **5.4M** | **1,231.8M** | **$2,245.02** | **$10,170.21** | **$932.79** |

_1,299.0M total tokens processed. 94.8% cache hit rate._

_$11,103.00 total saved ($10,170.21 caching + $932.79 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 4,999 | 7K | 1.9M | 622.3M | $1,079.03 | $8,402.27 | $0.00 |
| claude-sonnet-4-6 | 5,950 | 6K | 1.9M | 343.8M | $132.07 | $928.36 | $528.33 |
| anthropic/claude-sonnet-4.6 | 21 | 137K | 11K | 1.0M | $0.87 | $2.77 | $3.56 |
| **Total** | **10,970** | **151K** | **3.8M** | **967.2M** | **$1,211.97** | **$9,333.40** | **$531.90** |

_1,138.5M total tokens processed. 89.3% cache hit rate._

_$9,865.30 total saved ($9,333.40 caching + $531.90 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-17 05:52 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
