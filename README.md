...
| User AI session hours | 3.3h | 5.0h | 49.2h | 49.2h |
| AI worker hours | 0.0h | 0.0h | 15.5h | 15.5h |
| AI concurrency hours | 4.1h | 6.6h | 76.7h | 76.7h |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 3,171 | 5K | 1.0M | 406.5M | $1,220.92 | $5,488.08 | $0.00 |
...
| **Total** | **13,372** | **254K** | **4.2M** | **992.9M** | **$1,516.14** | **$7,185.46** | **$887.70** |

_1,039.9M total tokens processed. 95.5% cache hit rate._

_$8,073.16 total saved ($7,185.46 caching + $887.70 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 3,177 | 5K | 1.0M | 406.5M | $685.43 | $5,488.08 | $0.00 |
| claude-sonnet-4-6 | 5,846 | 5K | 1.8M | 340.4M | $130.55 | $919.35 | $522.29 |
| anthropic/claude-sonnet-4.6 | 21 | 137K | 11K | 1.0M | $0.87 | $2.77 | $3.56 |
| **Total** | **9,044** | **148K** | **2.9M** | **748.0M** | **$816.85** | **$6,410.20** | **$525.85** |

_900.5M total tokens processed. 88.6% cache hit rate._

_$6,936.06 total saved ($6,410.20 caching + $525.85 model routing vs all-Opus)._
...
<!-- UPDATED-START -->
_Stats auto-updated 2026-04-13 02:31 UTC by [aidevops](https://aidevops.sh) pulse._
<!-- UPDATED-END -->
